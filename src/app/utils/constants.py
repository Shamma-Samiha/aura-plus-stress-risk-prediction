...
QUESTION_MAP = {
    "anxiety_level": {
        ...
        "help": "0 = No anxiety, 10 = Severe anxiety. Rate how anxious you've felt recently.",
    ...
    "depression": {
        "label": "Depression-related symptoms (0–10)",
        "help": "0 = No symptoms, 10 = Severe symptoms. Rate low mood or loss of interest.",
        "section": "Psychological",
        "type": "range",
        "min": 0,
        "max": 10,
    ...
    "self_esteem": {
        "label": "Self-esteem (0–10)",
        "help": "0 = Very low self-esteem, 10 = Very high self-esteem. Rate your confidence and self-worth.",
        "section": "Psychological",
        "type": "range",
        "min": 0,
        "max": 10,
